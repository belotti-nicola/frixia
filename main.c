...
{  
    ...
    proto_frixia_callbacks_q_t *proto_callbacks_q = create_proto_frixia_callbacks_q();
    add_proto_callback(proto_callbacks_q,TCP,4444,&goo,NULL);
    add_proto_callback(proto_callbacks_q,TCP,8888,&foo,NULL);
